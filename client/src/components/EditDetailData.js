...
const EditDetailData = () => {
  ...
  const getDetailData = async() => {
    ...
    setLattitude(response.data[0].canal_data[0].data[0].lattitude);
    setLongitude(response.data[0].canal_data[0].data[0].longitude);
    setTime(response.data[0].canal_data[0].data[0].time);
    setDepth(response.data[0].canal_data[0].data[0].depth);
  };
