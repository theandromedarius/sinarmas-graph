...
import { Chart as ChartJS, BarElement, PointElement, Title, CategoryScale } from 'chart.js';
import annotationPlugin from "chartjs-plugin-annotation";

ChartJS.register(BarElement, PointElement, CategoryScale, Title, annotationPlugin);
...
const ChartData = () => {
  ...
  const getData = async() => {
    ...
    setDimensi(response.data.canal_data[0].dimensi.panjang + ' X ' + response.data.canal_data[0].dimensi.lebar + ' X ' + response.data.canal_data[0].dimensi.tinggi);
            ...
            <table>
              <tbody>
                <tr>
                  ...
                  <td>{orderNo1} s.d. {orderNo2}</td>
                </tr>
                <tr>
                  <td>ID KANAL</td>
                  <td style={{padding: "0px 10px"}}>:</td>
                  <td>{canalId1}  s.d. {canalId2}</td>
                </tr>
                <tr>
                  <td>WL.</td>
                  <td style={{padding: "0px 10px"}}>:</td>
                  <td>{waterLevel1} m s.d. {waterLevel2} m</td>
                </tr>
                <tr>
                  <td>DIMENSI</td>
                  <td style={{padding: "0px 10px"}}>:</td>
