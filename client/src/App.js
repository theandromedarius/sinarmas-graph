  ...
  return (
    ...
    <div className="container">
      <Routes>
        ...
        <Route path="viewData/:id/viewDetailData/:id" element={<DetailDataList/>}/>
        <Route path="viewData/:id/viewDetailData/:id/addDetail/:id" element={<AddDetailData/>}/>
        <Route path="viewData/:id/viewDetailData/:id/editDetail/:id" element={<EditDetailData/>}/>
        <Route path="viewData/:id/viewDetailData/:id/chartDetail/:id" element={<ChartDetailData/>}/>
